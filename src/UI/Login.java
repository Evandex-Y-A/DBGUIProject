...
/**
 * Panel providing the login form for the Story Keeper App.
 * <p>
 * Contains fields for username and password, a login button,
 * a link to the registration form, and a checkbox to show/hide
 * the password. On successful authentication, switches to the main UI.
 * </p>
 * 
 * @see UserDAO
 * @see Frame#showMainUI()
 * 
 * @author evandex
 */
public class Login extends JPanel {
    ...
    /**
     * Reference to the parent application frame, used to switch views.
     */
     ...
     *
     * @param frame the parent Frame in which this panel is displayed
     */
     ...
     * <p>
     * Intended to be called when logging out or resetting the form.
     * </p>
     */
    ...
    /**
     * Switches the card layout to display the registration form
     * when the "Register here" label is clicked.
     *
    ...
    /**
     * Attempts to authenticate the user when the login button is clicked.
     * <p>
     * Reads the username and password fields, calls {@link UserDAO#userLogin},
     * and on success invokes {@link Frame#showMainUI()}; otherwise shows
     * an error dialog.
     * </p>
     *
    ...
    /**
     * Toggles the visibility of the password field when
     * the "Show Password" checkbox is selected or deselected.
     *
     * @param evt the action event (ignored)
     */
    ...
    /**
     * Changes the cursor to a hand when hovering over the register label.
     *
     * @param evt the mouse event (ignored)
     */
    ...
    /**
     * Resets the cursor when the mouse exits the register label.
     *
     * @param evt the mouse event (ignored)
     */
